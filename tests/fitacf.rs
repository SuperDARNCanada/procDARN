...
use std::iter::zip;
use dmap::{FitacfRecord, RawacfRecord, Record};

#[test]
fn test_fitacf3() {
    // Create fitacf file from rawacf file
    let rawacf = RawacfRecord::read_file("tests/test_files/test.rawacf".to_string())
    ...
    let rst_records = FitacfRecord::read_file("tests/test_files/test.fitacf".to_string())
