...
fn main() {
    ...
    let aacgm_coeffs_path = std::env::var("DEP_AACGMV2_COEFFS_DAT_PREFIX")
        .expect("DEP_AACGMV2_RS_COEFFS_DAT_PREFIX missing");
    let igrf_coeffs_path =
        std::env::var("DEP_AACGMV2_IGRF_COEFFS").expect("DEP_AACGMV2_RS_IGRF_COEFFS");
