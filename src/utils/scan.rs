...
impl RadarScan {
    ...
    pub fn get_first_scan(
        ...
        while i < fit_records.len() {
            ...
            let groundscatter = match rec.get(&"gflg".to_string()) {
                Some(x) => {
